...
interface EkonomiPageProps {
  onIndicatorClick: (indicator: IndicatorData) => void
}

export function EkonomiPage({ onIndicatorClick }: EkonomiPageProps) {
  ...
  useEffect(() => {
    const fetchIndicators = async () => {
      try {
        setLoading(true)
        const response = await fetch('/api/public/indicators?category=Statistik%20Ekonomi&includeData=true')
  ...
  // Category mapping for illustrations
  const categoryIcons = {
    PDRB: "/icons/pdrb-icon.png",
    "PDRB PerKapita": "/icons/pdrb-perkapita-icon.png",
    "Inflasi": "/icons/inflasi-icon.png",
  }

  const categoryIllustrations = {
    PDRB: "/images/pdrb-illustration.png",
    "PDRB PerKapita": "/images/pdrb-perkapita-illustration.png",
    "Inflasi": "/images/inflasi-illustration.png",
  }
    ...
    <div className="min-h-screen">
      <div className="container mx-auto px-6 pt-6 pb-8">
        <div className="relative overflow-hidden rounded-3xl shadow-xl">
          <div
            className="absolute inset-0 bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-600"
            style={{
          ...
          <div className="relative z-10 px-8 py-12 lg:py-16">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight drop-shadow-lg">
                Statistik Ekonomi
                <span className="block text-orange-50 text-2xl md:text-3xl lg:text-4xl mt-1 drop-shadow-md">Kabupaten Bungo</span>
              </h1>

              <p className="text-base md:text-lg text-white/95 max-w-3xl mx-auto leading-relaxed font-light drop-shadow-sm">
                Menampilkan data ekonomi makro seperti PDRB, inflasi, nilai tukar, perdagangan, dan indikator ekonomi
                yang mendukung analisis perekonomian daerah
              </p>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-orange-200/40 p-6">
            <div className="flex flex-col lg:flex-row gap-4 items-center">
              <div className="relative flex-1 w-full">
                ...
                <Input
                  type="text"
                  placeholder="Cari indikator ekonomi berdasarkan nama atau kategori..."
                  value={searchQuery}
                      ...
                      >
                        ...
                        >
                          ...
                          <div className="relative z-10 flex-1 flex items-center justify-between">
                            ...
                            {/* Large Illustration positioned at bottom right */}
                            {illustrationSrc && (
