...
interface LingkunganPageProps {
  onIndicatorClick: (indicator: IndicatorData) => void
}

export function LingkunganPage({ onIndicatorClick }: LingkunganPageProps) {
  ...
  useEffect(() => {
    const fetchIndicators = async () => {
      try {
        setLoading(true)
        const response = await fetch('/api/public/indicators?category=Statistik%20Lingkungan%20Hidup%20%26%20Multi-Domain&includeData=true')
  ...
  const categoryIcons = {
    "Indeks Pembangunan": "/icons/indeks-pembangunan-icon.png",
    Gender: "/icons/gender-icon.png",
  }

  const categoryIllustrations = {
    "Indeks Pembangunan": "/images/indeks-pembangunan-illustration.png",
    Gender: "/images/gender-illustration.png",
  }
    ...
    <div className="min-h-screen">
      <div className="container mx-auto px-6 pt-6 pb-8">
        <div className="relative overflow-hidden rounded-3xl shadow-xl">
          <div
            className="absolute inset-0 bg-gradient-to-br from-green-500 via-green-600 to-emerald-600"
            style={{
              backgroundImage: "url(/images/lingkungan-bg.jpg)",
          ...
          <div className="relative z-10 px-8 py-12 lg:py-16">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight drop-shadow-lg">
                ...
                <span className="block text-orange-50 text-2xl md:text-3xl lg:text-4xl mt-1 drop-shadow-md">& Multi-Domain</span>
              </h1>

              <p className="text-base md:text-lg text-white/95 max-w-3xl mx-auto leading-relaxed font-light drop-shadow-sm">
                Menyediakan data lingkungan hidup, indeks pembangunan manusia, dan indikator lintas sektor yang
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-orange-200/40 p-6">
            <div className="flex flex-col lg:flex-row gap-4 items-center">
              <div className="relative flex-1 w-full">
                ...
                <Input
                  type="text"
                  placeholder="Cari indikator lingkungan berdasarkan nama atau kategori..."
                  value={searchQuery}
                              ...
                              <div className="absolute bottom-0 right-0 z-10">
                                <div className="w-48 h-36">
                                  <Image
                                    ...
                                    quality={95}
                                    priority={subcategory === "Indeks Pembangunan"}
                                  />
                                </div>
                              </div>
                            )}
